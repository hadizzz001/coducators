    ...
    <div className="min-h-screen flex flex-col dark:bg-gray-900 dark:text-white">
      ...
      >
        <div className="container mx-auto px-4 dark:bg-gray-900 dark:text-white">
          ...
          <div className="flex relative flex-wrap gap-6 justify-between items-start px-5 mt-10 w-full lg:min-h-[550px] max-md:max-w-full dark:bg-gray-900 dark:text-white">
      ...
      : 'red'
        ...
        <div className="  flex items-center justify-center mt-5">
          ...
          {showModal && (
            ...
            className="w-full px-4 py-2 border rounded-md text-black text-black"
            onChange={handleChange}
            value={inputs.forr}
            required
          />
